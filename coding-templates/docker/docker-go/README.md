# PlanQK Custom Docker Container Coding Template for Go

This is a simple Go application that takes a JSON file as input, sums up the values in the `values` property, and returns the result as a JSON object.
