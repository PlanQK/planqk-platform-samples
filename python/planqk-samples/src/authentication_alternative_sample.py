...
# create access_token
with OAuth2Session(client=LegacyApplicationClient(client_id=client_id)) as oauth:
    token = oauth.fetch_token("https://platform.planqk.de/auth/realms/planqk/protocol/openid-connect/token",
